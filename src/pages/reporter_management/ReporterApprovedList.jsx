...
const ReporterApprovedList = () => {
  const dispatch = useDispatch();
  const navigate = useNavigate();
  const { approvedReporters } = useSelector((store) => store.reporter);
  ...
  useEffect(() => {
    let filter_trans = approvedReporters;
    if (search !== "") {
  ...
  }, [search, end_date, start_date, approvedReporters]);
...
export default ReporterApprovedList;

...
const ReporterBlockList = () => {
  const dispatch = useDispatch();
  const navigate = useNavigate();
  const { blockedReporters } = useSelector((store) => store.reporter);
  ...
  useEffect(() => {
    let filter_trans = blockedReporters;
    if (search !== "") {
  ...
  }, [search, end_date, start_date, blockedReporters]);
...
export default ReporterBlockList;

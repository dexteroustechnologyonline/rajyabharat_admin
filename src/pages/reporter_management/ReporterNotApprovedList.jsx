...
const ReporterNotApprovedList = () => {
  const dispatch = useDispatch();
  const navigate = useNavigate();
  const { notApprovedReporters } = useSelector((store) => store.reporter);
  ...
  useEffect(() => {
    let filter_trans = notApprovedReporters;
    if (search !== "") {
  ...
  }, [search, end_date, start_date, notApprovedReporters]);
...
export default ReporterNotApprovedList;

...
import { categoryTagDelete } from "../../../redux/categorytag/CategoryTagSlice";
...
const ListCategoryTag = () => {
  ...
  const deleteClick = async (e) => {
    ...
    const deletclick = await dispatch(categoryTagDelete(id));
    if (deletclick.payload.success) {
      setModal(false);
      messageApi.open({
        type: "success",
        content: "Category Tag deleted  successfully",
      });
    }
  };

  useEffect(() => {
    let filter_trans = categoryTagtotal;
    if (search !== "") {
  ...
  }, [search, end_date, start_date, categoryTagtotal]);
      ...
      <div className="main_fragnent_container p-2">
        <div className="profile_container_header">
          <div className="profile_co_header_left">
            <span>Search Category Tags</span>
            <span
              style={{
                visibility: "hidden",
              }}
                      ...
                      <StyledTableRow key={index}>
                        ...
                        >
                          <span
                            ...
                            onClick={() => {
                              navigate(
                                `/admin/update-category-tag/${data.slugUrl}`
                              );
                            }}
                          >
                            {data.name}
                        ...
                        >
                          ...
                          >
                            <Link
                              to={`/admin/update-category-tag/${data.slugUrl}`}
                            >
...
export default ListCategoryTag;

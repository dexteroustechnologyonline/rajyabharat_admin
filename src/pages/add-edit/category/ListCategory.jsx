...
const ListCategory = () => {
  ...
  const statusChange = async (e, data) => {
    ...
    const updateprod = await dispatch(categoryUpdate(formData));
  };
  ...
  }, [search, end_date, start_date, allCategorys]);
                      ...
                      <StyledTableRow key={index}>
                        ...
                        >
                          <span
                            ...
                            onClick={() => {
                              navigate(
                                `/admin/update-category/${data.slugUrl}`
                              );
                            }}
                          >
                            {data.name}
                        ...
                        >
                          ...
                          >
                            <Link to={`/admin/update-category/${data.slugUrl}`}>
